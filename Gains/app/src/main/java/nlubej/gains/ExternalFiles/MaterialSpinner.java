...
public class MaterialSpinner extends Spinner implements ValueAnimator.AnimatorUpdateListener {
    ...
    */
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        setBackgroundResource(fr.ganfra.materialspinner.R.drawable.my_background);

    }

    private void initAttributes(Context context, AttributeSet attrs) {

        TypedArray a = context.obtainStyledAttributes(new int[]{fr.ganfra.materialspinner.R.attr.colorControlNormal, fr.ganfra.materialspinner.R.attr.colorAccent});
        int defaultBaseColor = a.getColor(0, 0);
        int defaultHighlightColor = a.getColor(1, 0);
        int defaultErrorColor = context.getResources().getColor(fr.ganfra.materialspinner.R.color.error_color);

        a.recycle();

        TypedArray array = context.obtainStyledAttributes(attrs, fr.ganfra.materialspinner.R.styleable.MaterialSpinner);
        baseColor = array.getColor(fr.ganfra.materialspinner.R.styleable.MaterialSpinner_ms_baseColor, defaultBaseColor);
        highlightColor = array.getColor(fr.ganfra.materialspinner.R.styleable.MaterialSpinner_ms_highlightColor, defaultHighlightColor);
        errorColor = array.getColor(fr.ganfra.materialspinner.R.styleable.MaterialSpinner_ms_errorColor, defaultErrorColor);
        disabledColor = context.getResources().getColor(fr.ganfra.materialspinner.R.color.disabled_color);
        error = array.getString(fr.ganfra.materialspinner.R.styleable.MaterialSpinner_ms_error);
        hint = array.getString(fr.ganfra.materialspinner.R.styleable.MaterialSpinner_ms_hint);
        floatingLabelText = array.getString(fr.ganfra.materialspinner.R.styleable.MaterialSpinner_ms_floatingLabelText);
        floatingLabelColor = array.getColor(fr.ganfra.materialspinner.R.styleable.MaterialSpinner_ms_floatingLabelColor, baseColor);
        multiline = array.getBoolean(fr.ganfra.materialspinner.R.styleable.MaterialSpinner_ms_multiline, true);
        minNbErrorLines = array.getInt(fr.ganfra.materialspinner.R.styleable.MaterialSpinner_ms_nbErrorLines, 1);
        alignLabels = array.getBoolean(fr.ganfra.materialspinner.R.styleable.MaterialSpinner_ms_alignLabels, true);
        thickness = array.getDimension(fr.ganfra.materialspinner.R.styleable.MaterialSpinner_ms_thickness, 1);
        thicknessError = array.getDimension(fr.ganfra.materialspinner.R.styleable.MaterialSpinner_ms_thickness_error, 2);
        arrowColor = array.getColor(fr.ganfra.materialspinner.R.styleable.MaterialSpinner_ms_arrowColor, baseColor);
        arrowSize = array.getDimension(fr.ganfra.materialspinner.R.styleable.MaterialSpinner_ms_arrowSize, dpToPx(DEFAULT_ARROW_WIDTH_DP));

        String typefacePath = array.getString(fr.ganfra.materialspinner.R.styleable.MaterialSpinner_ms_typeface);
    ...
    private void initPaintObjects() {
        ...
        int labelTextSize = getResources().getDimensionPixelSize(fr.ganfra.materialspinner.R.dimen.label_text_size);
    ...
    private void initDimensions() {
        underlineTopSpacing = getResources().getDimensionPixelSize(fr.ganfra.materialspinner.R.dimen.underline_top_spacing);
        underlineBottomSpacing = getResources().getDimensionPixelSize(fr.ganfra.materialspinner.R.dimen.underline_bottom_spacing);
        floatingLabelTopSpacing = getResources().getDimensionPixelSize(fr.ganfra.materialspinner.R.dimen.floating_label_top_spacing);
        floatingLabelBottomSpacing = getResources().getDimensionPixelSize(fr.ganfra.materialspinner.R.dimen.floating_label_bottom_spacing);
        rightLeftSpinnerPadding = alignLabels ? getResources().getDimensionPixelSize(fr.ganfra.materialspinner.R.dimen.right_left_spinner_padding) : 0;
        floatingLabelInsideSpacing = getResources().getDimensionPixelSize(fr.ganfra.materialspinner.R.dimen.floating_label_inside_spacing);
        errorLabelSpacing = (int) getResources().getDimension(fr.ganfra.materialspinner.R.dimen.error_label_spacing);
    ...
    */
    ...
    private class HintAdapter extends BaseAdapter
    {
        ...
        private View getHintView(ViewGroup parent, boolean isDropDownView) {
            ...
            textView.setTextColor(MaterialSpinner.this.isEnabled()? disabledColor : disabledColor);
