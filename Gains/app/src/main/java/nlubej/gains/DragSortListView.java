...
public class DragSortListView extends ListView {
 ...
 /*   public void kill(ListAdapter adapter) {
    	adapter.unregisterDataSetObserver(mObserver);
    	observerStatus = false;
    }
    */
    public boolean getStatus(ListAdapter adapter) {
    ...
    public void moveItem(int from, int to) {
        if (mDropListener != null) {
          ...
          //  key gre na position
            ...
            //TODO funkcijo ki vrne names in ids
        }
    }
	...
	public void setRoutines(long[] idss, String[] names) {
		this.ids = idss;
		this.names = names;
