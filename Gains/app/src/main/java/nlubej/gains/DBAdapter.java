...
public class DBAdapter {
	...
	public static final String KEY_SET = "sett";
	public static final String KEY_WEIGHT = "weight";
	public static final String KEY_REP = "rep";
	public static final String KEY_DURATION = "duration";
	public static final String KEY_WORKOUT_NUM = "workoutNum";
    ...
    private static final String DATABASE_NAME = "fitTrackerDB.db";
    
    private static final String DATABASE_TABLE_PROGRAM = "program";
    private static final String DATABASE_TABLE_EXERCISE = "exercise"; 
    private static final String DATABASE_TABLE_ROUTINE = "routine"; 
    private static final String DATABASE_TABLE_ACHIEVEMENT_LOG = "achievementLog";
    ...
    private static final String CREATE_TABLE_PROGRAM = "create table if not exists program (id integer primary key autoincrement, name VARCHAR not null);";
    private static final String CREATE_TABLE_EXERCISE = "create table if not exists exercise (id integer primary key autoincrement, position integer not null, name VARCHAR not null, type VARCHAR not null, routineID integer not null, programID integer not null);";
    private static final String CREATE_TABLE_ROUTINE = "create table if not exists routine (id integer primary key autoincrement, position integer not null, name VARCHAR not null , programID integer not null);";
    private static final String CREATE_TABLE_LOG = "create table if not exists log (id integer primary key autoincrement, sett integer not null, weight double, rep integer, duration VARCHAR, distance double, date VARCHAR not null, workoutNum integer not null, type VARCHAR not null, routineID integer not null, exerciseID integer not null);";
    private static final String CREATE_TABLE_USER = "create table if not exists user (id integer primary key autoincrement, weight double, height VARCHAR, tutorialStart integer not null, tutorialMain integer not null );";
    ...
    private static final String CREATE_TABLE_NOTE = "create table if not exists note (id integer primary key autoincrement, note TEXT, workoutNum integer not null, exerciseID integer not null);";
    ...
    public class DatabaseHelper extends SQLiteOpenHelper 
    {
        ...
        public void createDb(SQLiteDatabase db) {
			...
			db.execSQL(CREATE_TABLE_ACHIEVEMENT_LOG);
...
// CRUD below
    ...
    public long insertProgram(String program) 
    {
        ...
        return db.insert(DATABASE_TABLE_PROGRAM, null, initialValues);
    }
	...
	public boolean deleteLogByRoutine(long routineId) {
		return db.delete(DATABASE_TABLE_LOG, KEY_ROUTINEID + "=" + routineId, null) > 0;
